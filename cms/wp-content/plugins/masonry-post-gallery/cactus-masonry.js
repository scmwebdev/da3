/*** NOTE ***/
function Cactus_Masonry(showLoader, infiniteScroll, postsPerPage, id, IE9, width, softGutter, fitWidth, forceAutoWidth, transitionDuration)
{	
	/************************/
	/*	PUBLIC VARIABLES	*/
	/************************/
	...
	that.transitionDuration = transitionDuration;
	that.spinner = null;
	that.spinbox = null;
